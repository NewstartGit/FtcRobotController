package org.firstinspires.ftc.teamcode.CENTERSTAGE.BLUESIDE.A_SIDE;
...
@Autonomous(name="BLUE FS-A CORNER PARK ONLY", group="Linear Opmode")
public class RoadrunnerAutoFRONTSTAGE_BLUECORNER_A_PARKONLY extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory positionThreeCorner = drive.trajectoryBuilder(positionThreeToRightCorner.end(), false)
                .lineToSplineHeading(new Pose2d(-62,50,Math.toRadians(-270)))
                .build();
